"""
Django settings for Yasinta181108 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-q!c$*%*nk9*z^v)za-l0kp1(im6x^&fdxr41025+wx2r348els')
...
ROOT_URLCONF = 'Yasinta181108.urls'
...
WSGI_APPLICATION = 'Yasinta181108.wsgi.application'
